              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent className="w-56 bg-slate-900 border-slate-700 text-white" align="end">
                  ...
                  <DropdownMenuItem asChild>
                    <Link href="/dashboard" className="cursor-pointer text-slate-200 hover:text-white focus:bg-slate-800">
                  ...
                  {isAdmin && (
                    <DropdownMenuItem asChild>
                      <Link href="/admin" className="cursor-pointer text-cyan-400 font-semibold focus:bg-slate-800">
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            {user && (
              <>
                ...
                {isAdmin && (
                  <Link href="/admin"
                    className="text-cyan-400 hover:text-cyan-300 block px-3 py-2 rounded-md text-base font-medium"
                    onClick={() => setMenuOpen(false)}>
                    Admin Panel
                  </Link>
                )}
            ...
            {!user && (
              <Link href="/login"
                className="text-cyan-400 hover:text-cyan-300 block px-3 py-2 rounded-md font-bold"
                onClick={() => setMenuOpen(false)}>
                Sign In
              </Link>
            )}
