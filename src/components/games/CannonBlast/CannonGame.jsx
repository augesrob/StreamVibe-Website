          ...
          {(phase==='climbing'||phase==='stun') && (
            <g>
              <rect x={CANVAS_W-122} y={10} width={112} height={36} rx={8}
                fill="rgba(0,0,0,0.72)" stroke="rgba(255,215,0,0.5)" strokeWidth={1.5}/>
              <text x={CANVAS_W-66} y={33} textAnchor="middle" fontSize={20}
                fontWeight="900" fill="#ffd700" fontFamily="monospace">{currentDistance}m</text>
            </g>
          )}
          ...
          {maxDistance > 0 && (
            <g>
              <rect x={10} y={10} width={96} height={30} rx={7}
                fill="rgba(0,0,0,0.65)" stroke="rgba(255,215,0,0.3)" strokeWidth={1}/>
              <text x={58} y={30} textAnchor="middle" fontSize={12} fontWeight="bold" fill="#ffd700">
                🏆 {maxDistance}m
              </text>
            </g>
          )}
          ...
          {phase==='aiming' && (
            <g>
              <rect x={CANVAS_W/2-95} y={14} width={190} height={34} rx={10}
                fill="rgba(255,90,0,0.92)" stroke="#ff5500" strokeWidth={2}/>
              <text x={CANVAS_W/2} y={36} textAnchor="middle" fontSize={16} fontWeight="900" fill="white">
                🎯 AIMING...
              </text>
            </g>
          )}
          ...
          {phase==='stun' && (
            <g>
              <rect x={CANVAS_W/2-85} y={14} width={170} height={26} rx={7}
                fill="rgba(0,0,0,0.78)" stroke="#ff3333" strokeWidth={2}/>
              <rect x={CANVAS_W/2-83} y={16} width={166*stunPct} height={22} rx={6} fill="#ff3333"/>
              <text x={CANVAS_W/2} y={32} textAnchor="middle" fontSize={11} fontWeight="bold" fill="white">
                😵 RECOVERING...
              </text>
            </g>
          )}
