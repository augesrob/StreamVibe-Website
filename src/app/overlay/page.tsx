...
export default function OverlayPage() {
  ...
  // 2. Subscribe to Realtime broadcast once validated
  useEffect(() => {
    ...
    // Fallback: also poll localStorage in case same browser
  ...
  if (authState === 'noPlan') return (
    <div className="fixed inset-0 flex items-center justify-center bg-black text-yellow-400 font-mono text-sm text-center p-8">
      ⚠️ StreamVibe Basic plan or above required to use the overlay.
    </div>
  )
